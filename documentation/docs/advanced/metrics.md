...
Prometheus metrics can be enabled to monitor your Transmission instances. When enabled, metrics are served on a **separate port** (default: 9074) with **no authentication required** for easier monitoring setup.
