...
RUN CGO_ENABLED=0 go build -trimpath -ldflags="\
    -s -w \
    -X github.com/fullerhkz/qui-transmission/internal/buildinfo.Version=${VERSION} \
    -X github.com/fullerhkz/qui-transmission/internal/buildinfo.Date=${BUILDTIME} \
    -X github.com/fullerhkz/qui-transmission/internal/buildinfo.Commit=${REVISION} \
