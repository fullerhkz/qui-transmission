...
export const CONDITION_FIELDS = {
  ...
  DOWNLOAD_PATH: { label: "Download Path", type: "string" as const, description: "Session download path from Transmission" },
  ...
  MAX_RATIO: { label: "Max Ratio", type: "float" as const, description: "Maximum ratio value from Transmission" },
...
export const HARDLINK_SCOPE_VALUES = [
  ...
  { value: "outside_qbittorrent", label: "Outside Transmission (library/import)" },
];

// Transmission torrent states
export const TORRENT_STATES = [
  ...
  // Specific client state kept for targeting missing-file issues.
...
export const CAPABILITY_REASONS = {
  trackerHealth: "Requires tracker health support from Transmission RPC",
